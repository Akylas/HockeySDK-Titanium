...
public class CrashManager {
  ...
  public static void register(Context context, String urlString, String appIdentifier, CrashManagerListener listener) {
    ...
    Boolean ignoreDefaultHandler = true; //(listener != null) && (listener.ignoreDefaultHandler());
    if (hasStackTraces()) {
  ...
  private static void showDialog(final Context context, final CrashManagerListener listener, final boolean ignoreDefaultHandler) {
    ...
    builder.setTitle("Crash Data");
    builder.setMessage("The app found information about previous crashes. Would you like to send this data to the developer?");
